...
namespace SuperRocket.AspNetCoreAngular.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = AspNetCoreAngularConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(AspNetCoreAngularDbContext context)
        {
            _context = context;
        }
